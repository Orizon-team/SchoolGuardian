...
export function ProfileCard({ name, email, role, width = "w-80" }: ProfileCardProps) {
  return (
    <section className={`bg-secondaryOri border-2 border-greyOri p-5 rounded-lg shadow-lg ${width}`}>
